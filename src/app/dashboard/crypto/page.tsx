      ...
      <Stack spacing={3}>
        ...
        <Grid container spacing={3}>
          {(
            ...
            ] satisfies { coin: string; diff: number; trend: 'up' | 'down'; amount: number; value: number }[]
          ).map(
                ...
                data={[
                  {
                    ...
                    volume1d: '$9.2B',
                    summary: [
                      28363, 30341, 31841, 32385, 33657, 27051, 29299, 26677, 28111, 27386, 26010, 33147, 33332, 26205,
                      32235, 30596, 30926, 33985, 33634, 29522,
                    ],
                  },
                  {
                    id: 'ETH',
