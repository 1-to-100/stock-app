...
import type { Invoice } from '@/components/dashboard/settings/invoices-table';
import { PaymentMethodCard } from '@/components/dashboard/settings/payment-method-card';
import type { PaymentMethod } from '@/components/dashboard/settings/payment-method-card';
      ...
      <Stack spacing={3}>
        ...
        <Grid container spacing={3}>
          {(
            ...
            (paymentMethod): React.JSX.Element => (
