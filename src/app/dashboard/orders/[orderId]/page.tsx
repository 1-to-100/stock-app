...
import type { OrderEvent } from '@/components/dashboard/order/events-timeline';
      ...
      <Stack spacing={3}>
        ...
        <Stack divider={<Divider />} spacing={5}>
          ...
          <Stack spacing={3}>
            ...
            <Stack spacing={1}>
              ...
              <div>
                ...
                <div>
                  <Link level="body-sm" startDecorator={<PhoneIcon fontSize="var(--joy-fontSize-md)" weight="bold" />}>
                    (801) 301-7140
                  </Link>
                </div>
              </div>
                ...
                <Stack spacing={5}>
                  ...
                  <Stack direction="row" spacing={2} sx={{ flexWrap: 'wrap' }}>
                    {(
                      ...
                      ] satisfies { label: string; status: 'pending' | 'current' | 'done' }[]
                    ).map(
                      (item): React.JSX.Element => (
          ...
          <Stack spacing={3}>
            ...
            <Typography>
              &quot;Please ensure that the package is securely wrapped to protect fragile items. If no one is available
              to receive the delivery, kindly leave it with a trusted neighbor. Thank you for your excellent
              service!&quot;
            </Typography>
          </Stack>
        </Stack>
