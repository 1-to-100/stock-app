...
import type { Shipment } from '@/components/dashboard/logistics/shipping-history';
...
export const metadata = { title: `Logistics | Dashboard | ${config.site.name}` } satisfies Metadata;
