  ...
  return (
    <Box sx={{ p: 'var(--Content-padding)' }}>
      <Stack spacing={3}>
        ...
        <Stack spacing={4}>
          <Stack direction={{ xs: 'column-reverse', sm: 'row' }} spacing={2} sx={{ alignItems: { sm: 'flex-start' } }}>
            ...
            <LineItemsTable
              rows={
                [
                  ...
                  { id: 'LI-003', product: 'Bose Headphones', quantity: 2, currency: 'USD', unitPrice: 45, amount: 90 },
                ] satisfies LineItem[]
              }
            />
          </Card>
