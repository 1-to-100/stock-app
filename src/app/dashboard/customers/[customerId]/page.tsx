...
import type { Invoice } from '@/components/dashboard/customer/invoices-table';
import { ShippingAddressCard } from '@/components/dashboard/customer/shipping-address-card';
import type { ShippingAddress } from '@/components/dashboard/customer/shipping-address-card';
